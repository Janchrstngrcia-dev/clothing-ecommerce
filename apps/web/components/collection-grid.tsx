      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:pt-12">
            <ProductCard {...products[0] as any} index={0} />
          </div>
          <div>
            <ProductCard {...products[1] as any} index={1} />
          </div>
          <div className="lg:pt-24">
            <ProductCard {...products[2] as any} index={2} />
          </div>

          {/* Second row - different offset */}
          <div>
            <ProductCard {...products[3] as any} index={3} />
          </div>
          <div className="lg:pt-16">
            <ProductCard {...products[4] as any} index={4} />
          </div>
          <div className="lg:-mt-8">
            <ProductCard {...products[5] as any} index={5} />
          </div>
        </div>
